...
/**
 * Created by AKshay on 8/27/2017.
 */

class LessonSevenRenderer implements GLSurfaceView.Renderer {

        /** Used for debug logs. */
        private static final String TAG = "LessonSevenRenderer";

        private final LessonSeventh mLessonSevenActivity;
         ...
         */
        public LessonSevenRenderer(final LessonSeventh lessonSevenActivity, final GLSurfaceView glSurfaceView) {
...
//						Toast.makeText(mLessonSevenActivity, "Out of memory; Dalvik takes a while to clean up the memory. Please try again.\nExternal bytes allocated=" + dalvik.system.VMRuntime.getRuntime().getExternalBytesAllocated(), Toast.LENGTH_LONG).show();
        ...
        public void onSurfaceCreated(GL10 glUnused, EGLConfig config)
        {
            ...
            // Load the texture
            mAndroidDataHandle = TextureHelper.loadTexture(mLessonSevenActivity, R.drawable.ganpati);
