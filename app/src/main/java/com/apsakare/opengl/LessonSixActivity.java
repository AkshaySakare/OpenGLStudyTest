    ...
    private void setMinSetting(final int item)
    {
        ...
        mGLSurfaceView.queueEvent(new Runnable()
        {
            ...
            public void run()
            {
                ...
                if (item == 0)
                {
                    filter = GLES10.GL_NEAREST;
                }
                else if (item == 1)
                {
                    filter = GLES10.GL_LINEAR;
                }
                else if (item == 2)
                {
                    filter = GLES10.GL_NEAREST_MIPMAP_NEAREST;
                }
                else if (item == 3)
                {
                    filter = GLES10.GL_NEAREST_MIPMAP_LINEAR;
                }
                else if (item == 4)
                {
                    filter = GLES10.GL_LINEAR_MIPMAP_NEAREST;
                }
                else // if (item == 5)
                {
                    filter = GLES10.GL_LINEAR_MIPMAP_LINEAR;
                }
